"""
Shrimp Detection & Measurement System
======================================
Menggunakan YOLOv11 segmentation + regression model
untuk mendeteksi, mengukur, dan melacak udang secara real-time.
"""
...
def draw_bounding_box(
    ...
    cv2.drawContours(frame, [box], 0, config.COLOR_BBOX, 2)
    x, y = box[0]
    cv2.putText(
        frame, label,
        (int(x), int(y) - 10),
